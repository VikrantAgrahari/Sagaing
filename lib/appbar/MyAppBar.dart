...
class MyAppBar extends StatefulWidget {
  ...
  int pagenumber;
  MyAppBar(this.text, this.controller, this.controller2, this.pagenumber);
}
    ...
    void _selectedNames(value) {
      ...
      setState(() {
        if (widget.pagenumber == 0) {
          selectedNamesForLaw =
              names.where((name) => name.contains(value)).toList();
        }
        if (widget.pagenumber == 1) {
          selectedNamesForHandbook =
              listForHandbook.where((name) => name.contains(value)).toList();
        }
      });
      print(selectedNamesForLaw);
    }
